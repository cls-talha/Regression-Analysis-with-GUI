...
inline std::string predict4(std::string year_value)
{
    double year[100] = { 0 }, life[100] = { 0 };
    int counter{};
    std::string yr, avg;

    std::ifstream my_csv;
    my_csv.open("Dataset\\Pak_unemployment.csv");
    ...
    double x_x[100] = { 0 }, y_y[100] = { 0 }, x_x_y_y[100] = { 0 }, x_x2[100] = { 0 };
    double sum1 = 0, sum2 = 0, avg1 = 0, avg2 = 0;
    double SUM1 = 0, SUM2 = 0;
    double AVG1 = 0, AVG2 = 0, Su1 = 0, Su2 = 0;
    double stand[100] = { 0 }, Add[100] = { 0 }, add = 0, assume = 0, var = 0, STDEV = 0;
    ...
    double slope = 0, intercept = 0, Final = 0, ans = 0, Number = 0;
    std::string answer;
    ...
    std::ofstream ModelW("Trained_Model\\Trained_Para_Unemployment_Dataset.txt", std::ofstream::out);
    if (ModelW.is_open())
    {
    ...
    //double z = floor(Final * 100) / 100.0;
