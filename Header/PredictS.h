...
inline std::string predict3(std::string year_value)
{
    ...
    std::ifstream my_csv;
    my_csv.open("Dataset\\Salary_Data.csv");
    ...
    std::ofstream ModelW("Trained_Model\\Trained_Para_Salary_Dataset.txt", std::ofstream::out);
    if (ModelW.is_open())
    {
