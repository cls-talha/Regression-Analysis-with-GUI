...
inline std::string predict1(std::string year_value)
{
    ...
    std::ifstream my_csv;
    my_csv.open("Dataset\\Japan_LE.csv");
    ...
    std::ofstream ModelW("Trained_Model\\Trained_Para_Expectancy_Dataset.txt", std::ofstream::out);
    if (ModelW.is_open())
    {
