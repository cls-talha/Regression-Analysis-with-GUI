...
namespace Forms {
	...
	/// <summary>
	/// Summary for Unemloyment
	/// </summary>
	public ref class Unemloyment : public System::Windows::Forms::Form
	{
	public:
		Unemloyment(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Unemloyment::typeid));
			...
			this->pictureBox1->Location = System::Drawing::Point(612, 136);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(310, 457);
			...
			this->label1->Location = System::Drawing::Point(377, 27);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(665, 46);
			this->label1->TabIndex = 2;
			this->label1->Text = L"Pakistan Unemployment Rate Prediction";
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(108, 447);
			...
			this->button1->Location = System::Drawing::Point(256, 585);
			...
			this->button1->Click += gcnew System::EventHandler(this, &Unemloyment::button1_Click);
			// 
			// pictureBox2
			// 
			...
			this->pictureBox2->Location = System::Drawing::Point(74, 511);
			...
			this->label3->Location = System::Drawing::Point(83, 518);
			...
			this->Name = L"Unemloyment";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Unemloyment";
