...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Population::typeid));
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(307, 491);
			...
			this->pictureBox1->Location = System::Drawing::Point(587, 159);
			...
			this->label1->Location = System::Drawing::Point(379, 43);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(513, 46);
			this->label1->TabIndex = 3;
			this->label1->Text = L"Pakistan Population Prediction";
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(112, 483);
			...
			this->button1->Location = System::Drawing::Point(236, 603);
			...
			this->pictureBox2->Location = System::Drawing::Point(58, 539);
			...
			this->label3->Location = System::Drawing::Point(66, 545);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if ((Num_check >= 0) && (Num_check <= 3000))
		{
			...
			std::string conv = predict(input);
			String^ str = gcnew String(conv.c_str());
			double Result = System::Convert::ToDouble(str);
			String^ str1 = String::Format("{0:0.00}", Result);
			label3->Text = "Predicted Population is : " + str1 + " Million";
		}
	}
};
}