...
namespace Forms {
	...
	/// <summary>
	/// Summary for LandPrice
	/// </summary>
	public ref class LandPrice : public System::Windows::Forms::Form
	{
	public:
		LandPrice(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(LandPrice::typeid));
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(353, 490);
			...
			this->button1->Location = System::Drawing::Point(232, 606);
			...
			this->button1->Click += gcnew System::EventHandler(this, &LandPrice::button1_Click);
			// 
			// label1
			// 
			...
			this->label1->Location = System::Drawing::Point(73, 480);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(259, 32);
			this->label1->TabIndex = 2;
			this->label1->Text = L"Enter Area (Sq Foot): ";
			// 
			// label2
			// 
			...
			this->label2->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(0)), static_cast<System::Int32>(static_cast<System::Byte>(0)),
				static_cast<System::Int32>(static_cast<System::Byte>(0)), static_cast<System::Int32>(static_cast<System::Byte>(0)));
			this->label2->Font = (gcnew System::Drawing::Font(L"Segoe UI", 25, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->ForeColor = System::Drawing::Color::White;
			this->label2->Location = System::Drawing::Point(428, 28);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(359, 46);
			this->label2->TabIndex = 4;
			this->label2->Text = L"Land Price Prediction";
			// 
			// pictureBox1
			// 
			this->pictureBox1->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox1.Image")));
			this->pictureBox1->Location = System::Drawing::Point(609, 146);
			...
			this->pictureBox2->Location = System::Drawing::Point(42, 546);
			...
			this->label3->Location = System::Drawing::Point(50, 553);
			...
			this->Name = L"LandPrice";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"LandPrice";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if ((Num_check >= 0) && (Num_check <= 50000))
		{
			msclr::interop::marshal_context context;
			std::string input = context.marshal_as<std::string>(textBox1->Text);
			std::string conv = predict2(input);
			String^ str = gcnew String(conv.c_str());
			label3->Text = "Predicted Price of land is : $ " + str + "k";
		}
	}
};
}
