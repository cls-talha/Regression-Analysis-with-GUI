...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Salary::typeid));
			...
			this->pictureBox1->Location = System::Drawing::Point(584, 128);
			...
			this->label1->Location = System::Drawing::Point(422, 40);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(301, 46);
			this->label1->TabIndex = 1;
			this->label1->Text = L"Salary Prediction ";
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(34, 414);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(310, 32);
			this->label2->TabIndex = 2;
			this->label2->Text = L"Enter Years of Experience:";
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(201, 559);
			...
			this->button1->Click += gcnew System::EventHandler(this, &Salary::button1_Click);
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(364, 424);
			...
			this->pictureBox2->Location = System::Drawing::Point(27, 477);
			...
			this->label3->Location = System::Drawing::Point(36, 483);
